"""
Django settings for MenuReview project.
...
SECRET_KEY = 'django-insecure-%rb#)j4e_t)i*prk!570h%k^e#%*^ply(pb5hfiijk+k^=-ub@'
...
WSGI_APPLICATION = 'MenuReview.wsgi.application'
